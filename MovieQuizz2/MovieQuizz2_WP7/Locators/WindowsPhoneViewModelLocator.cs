...
using MovieQuizz2.Controllers;
using QuizzApp.Core.Controllers;
using QuizzApp.WP.ViewModels;
//using MovieQuizz2.ViewModels;
// Toolkit namespace
using SimpleMvvmToolkit;

namespace MovieQuizz2.Locators
{
    /// <summary>
    ...
    public class WindowsPhoneViewModelLocator
    {
        ...
        public LevelsList2ViewModel LevelsList2ViewModel
        {
            get { return new LevelsList2ViewModel(gameProvider); }
        }
